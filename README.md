...
It's possible to use this captcha with modern Angular 16+ apps too. Here is a sample to demonstrate it:

- [The server side controller](/src/DNTCaptcha.TestApiApp/Controllers/AccountController.cs)
- [The Angular 16+ DNTCaptcha component](/src/DNTCaptcha.ModernAngularClient/src/app/dnt-captcha)
- [A sample Angular 16+ login component](/src/DNTCaptcha.ModernAngularClient/src/app/login)
