...
<dnt-captcha asp-captcha-generator-max="9000"
             ...
             asp-captcha-template="<div class='col-md-12'>{0}{1}<div class='input-group col-md-4'><span class='input-group-addon'><span class='glyphicon glyphicon-lock'></span></span>{2}</div></div>"
...
<dnt-captcha asp-captcha-generator-max="9000"
             ...
             asp-captcha-template="<div class='col-md-12'>{0}{1}<div class='input-group'><span class='input-group-prepend'><span class='input-group-text'><i class='fas fa-lock'></i></span></span>{2}</div></div>"
             asp-validation-message-class="text-danger"
...
<dnt-captcha asp-captcha-generator-max="30"
			 ...
			 asp-captcha-template="<div class='col-md-12'>{0}{1}<div class='input-group'><span class='input-group-text'><span class='bi-lock'></span></span>{2}</div></div>"
			 asp-validation-message-class="text-danger"
