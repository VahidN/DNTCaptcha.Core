...
namespace DNTCaptcha.Core
{
    ...
    public class CaptchaImageProvider : ICaptchaImageProvider
    {
        ...
        private void DrawText(string text, SKCanvas canvas, SKShaper shaper,
        ...
        private static void DrawRectangle(SKCanvas canvas, float width, float height)
        {
            ...
            canvas.DrawRect(new SKRect(0, 0, width + 2 * TextMargin - 1,
        ...
        private static SKTypeface GetFont(string fontName, string? customFontPath)
        {
            ...
            {
                return FontsTypeface.GetOrAdd(fontName,
            ...
            return FontsTypeface.GetOrAdd(customFontPath,
                                          _ =>
                                          {
                                              using var embeddedFont = File.OpenRead(customFontPath);
                                              return SKTypeface.FromStream(File.OpenRead(customFontPath));
                                          });
        }
