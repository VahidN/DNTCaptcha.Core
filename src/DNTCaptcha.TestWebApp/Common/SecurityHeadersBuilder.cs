...
public static class SecurityHeadersBuilder
{
    public static HeaderPolicyCollection AddMyCustomCsp(this HeaderPolicyCollection hpc, bool isDevelopment)
    {
            ...
            .AddContentSecurityPolicy(builder =>
                                      {
                                          ...
                                          builder.AddImgSrc().Self().From("data:").From("blob:")
                                                 .From("https:");
                                          builder.AddFontSrc().Self();
                                          builder.AddStyleSrc().Self()
                                                 // Specify any additional hashes to permit your required inline styles to load.
                                                 // this is a sample ...
                                                 .WithHash256("bnIC0/ztx6X71evb78hypKsIopl034E0/ThEB7hd7Kg=")
                                          ...
                                          builder.AddScriptSrc().Self()
                                                 ...
                                                 // this is a sample ...
                                                 .WithHash256("aMaNJuD4ukqKzy4/Ho066vyaf6Ua7INNrDS7Oi8iA34=")
        ...
        hpc.ApplyDocumentHeadersToAllResponses();
        return hpc;
    }
}